...
class JReserveTest < Test::Unit::TestCase
  def setup
    @gateway = JReserveGateway.new(some_credential: 'login', another_credential: 'password')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_j_reserve_test.rb \
